...
import type { DatasetGroupRequest, GroupModificationRequest, Groups, PaginatedRequest, PaginatedResult, ViewTableGroups } from '@/plugins/types/germinate'
...
const apiPostGroupTable = <T>(queryData: PaginatedRequest, onSuccess?: GerminateResponseHandler<PaginatedResult<ViewTableGroups[]>>, onError?: ErrorHandler) => {
  queryData.page -= 1
  return authAxios<PaginatedResult<ViewTableGroups[]>>({ url: 'group/table', method: 'POST', data: queryData, success: onSuccess, error: onError })
}
