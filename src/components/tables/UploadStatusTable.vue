  ...
  data: function () {
    return {
      ...
      statusOptions: {
        ...
        GENERIC_DISPLAY_NAME_USED_BUT_NOT_UNIQUE: () => this.$t('importStatusGenericDisplayNameUsedButNotUnique'),
        ...
        CLIMATE_MISSING_LOCATION_DECLARATION: () => this.$t('importStatusTrialsMissingClimateLocationDeclaration'),
        ...
        TRIALS_ROW_COL_MISMATCH: () => this.$t('importStatusTrialsRowColMismatch'),
