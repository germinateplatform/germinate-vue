        ...
        <b-row>
          ...
          <b-col xs=12 sm=6 md=6 lg=4 xl=3 v-if="locationOptions && locationOptions.length > 2">
            ...
            <b-button-group class="mr-2">
              <b-button class="mb-2" variant="outline-secondary" @click="onHasImagesClicked" v-b-tooltip="$t('widgetGermplasmTableFilterHasImages')"><i class="mdi mdi-18px mdi-camera" /></b-button>
            </b-button-group>
            <b-button-group class="flex-wrap">
