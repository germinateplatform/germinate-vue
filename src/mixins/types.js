...
import { mdiSprout, mdiDna, mdiGrid, mdiLeaf, mdiMapMarker, mdiPulse, mdiWeatherSnowyRainy, mdiShovel, mdiFamilyTree, mdiHelpBox, mdiBasketFill, mdiDatabase, mdiNumeric, mdiAlphabetical, mdiCalendar, mdiTagText, mdiReorderVertical, mdiTagTextOutline, mdiFolderTable, mdiChartSankey, mdiImageMultiple, mdiGroup, mdiFileDownload, mdiShapeRectanglePlus, mdiMarker, mdiLockOpenVariantOutline, mdiLock, mdiEyeOff, mdiPassport, mdiEyedropper, mdiAllergy, mdiContentDuplicate, mdiGift, mdiWrenchClock } from '@mdi/js'
