<template>
  <b-container class="my-5">
    ...
    <b-card :title="$t('pageSetupDatabaseTitle')" :sub-title="$t('pageSetupDatabaseSubtitle')" :border-variant="dbBorder" class="mb-4">
      <b-form @submit.prevent="checkDatabaseSetup" class="mt-3">
        ...
        <b-button variant="primary" type="submit">{{ $t('buttonCheckDetails') }}</b-button>
    ...
    <!-- Gatekeeper config -->
    <b-card :class="`mb-4 ${gkConfig.used ? '' : 'bg-light text-muted'}`" :border-variant="gkBorder" v-if="dbConfig.checked">
      ...
      <b-form @submit.prevent="checkGatekeeperSetup" class="mt-3">
        ...
        <b-button variant="primary" type="submit" :disabled="!gkConfig.used || gkConfig.checked">{{ $t('buttonCheckDetails') }}</b-button>
