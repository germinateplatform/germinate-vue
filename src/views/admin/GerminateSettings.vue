  ...
  <div>
    ...
    <b-form id="admin-form" @submit.prevent="saveSettings" autocomplete="off" v-if="settings">
      <b-card-group columns>
        <b-card class="mb-3" :title="$t('pageGerminateSettingsCardColors')">
        ...
        <b-card class="mb-3" :title="$t('pageGerminateSettingsCardToggles')">
          <b-row>
            <b-col cols=12 lg=6 xl=12 class="mb-3 col-xxl-6">
              <b-card class="mb-3" :class="`toggle-card ${settings.brapiEnabled ? 'active' : null}`" :style="{ backgroundColor: settings.brapiEnabled ? settings.colorsTemplate[0] : null }" @click="settings.brapiEnabled = !settings.brapiEnabled">
            ...
            <b-col cols=12 lg=6 xl=12 class="mb-3 col-xxl-6">
              <b-card class="mb-3" :class="`toggle-card ${settings.commentsEnabled ? 'active' : null}`" :style="{ backgroundColor: settings.commentsEnabled ? settings.colorsTemplate[1] : null }" @click="settings.commentsEnabled = !settings.commentsEnabled">
                <div class="d-flex justify-content-between">
            ...
            <b-col cols=12 lg=6 xl=12 class="mb-3 col-xxl-6">
              <b-card class="mb-3" :class="`toggle-card ${settings.pdciEnabled ? 'active' : null}`" :style="{ backgroundColor: settings.pdciEnabled ? settings.colorsTemplate[2] : null }" @click="settings.pdciEnabled = !settings.pdciEnabled">
                <div class="d-flex justify-content-between">
            ...
            <b-col cols=12 lg=6 xl=12 class="mb-3 col-xxl-6">
              <b-card class="mb-3" :class="`toggle-card ${settings.showGdprNotification ? 'active' : null}`" :style="{ backgroundColor: settings.showGdprNotification ? settings.colorsTemplate[3] : null }" @click="settings.showGdprNotification = !settings.showGdprNotification">
                <div class="d-flex justify-content-between">
        ...
        <b-card class="mb-3" :title="$t('pageGerminateSettingsCardGatekeeper')">
        ...
        <b-card class="mb-3" :title="$t('pageGerminateSettingsCardBackups')">
          <b-form-group :label="$t('formLabelAdminSettingsBackupEveryDays')" :description="$t('formDescriptionAdminSettingsBackupEveryDays')" label-for="backup-every-days">
            <b-input-group>
              <b-form-input type="number" :min="1" :max="30" :steps="1" v-model.number="settings.databaseBackupEveryDays" id="backup-every-days" />
              <template #append>
                <b-input-group-text>{{ $t('genericDays') }}</b-input-group-text>
              </template>
            </b-input-group>
          </b-form-group>
          <b-form-group :label="$t('formLabelAdminSettingsBackupMaxSizeGb')" :description="$t('formDescriptionAdminSettingsBackupMaxSizeGb')" label-for="backup-max-size-gb">
            <b-input-group>
              <b-form-input type="number" :min="0.001" v-model.number="settings.databaseBackupMaxSizeGB" id="backup-max-size-gb" />
              <template #append>
                <b-input-group-text>GB</b-input-group-text>
              </template>
            </b-input-group>
          </b-form-group>
        </b-card>
        <b-card class="mb-3" :title="$t('pageGerminateSettingsCardTemplate')">
        ...
        <b-card class="mb-3" border-variant="danger">
          ...
          <b-form-group :label="$t('formLabelAdminSettingsFilesDeletedAfterAsync')" label-for="delete-async-files">
            <b-input-group>
              ...
              <template #append>
                <b-input-group-text>{{ $t('genericHours') }}</b-input-group-text>
              </template>
            </b-input-group>
          </b-form-group>
